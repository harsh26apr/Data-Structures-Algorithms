// C program to find circular tour for a car
#include <stdio.h> 
...
{ 
    ...
    int currFuel = arr[start].petrol - arr[start].distance; 
    ...
    { 
        ...
        { 
            ...
            currFuel -= arr[start].petrol - arr[start].distance; 
            start = (start + 1)%n; 
        ...
        currFuel += arr[end].petrol - arr[end].distance; 
